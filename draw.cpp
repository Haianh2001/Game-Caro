...
void initWindow()
{
	...
	{
		window = SDL_CreateWindow( "Five In A Line", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
		if( window != NULL )
		{
	...
	surface[4] = IMG_Load("playerwin.png");
	texture[4] = SDL_CreateTextureFromSurface( renderer, surface[4] );
	surface[5] = IMG_Load("playerlose.png");
